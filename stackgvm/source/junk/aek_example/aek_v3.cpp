...
namespace Ray {
     ...
     */
    Material::Kind traceNoBounce(cvr3 v_origin, cvr3 v_direction, float32& f_distance, Vec3& v_normal) {
...
namespace Sample {
    ...
    typedef Vec3 (*Function)(cvr3 v_origin, cvr3 v_direction);

    inline float32 calculateLambertian(cvr3 v_intersection, cvr3 v_normal, Vec3& v_light) {
    ...
    Vec3 sampleNoBounce(cvr3 v_origin, cvr3 v_direction) {
    ...
    Vec3 sampleFirstBounce(cvr3 v_origin, cvr3 v_direction) {
