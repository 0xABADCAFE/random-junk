...
g++ -Ofast -Wall -flto -W -ftree-vectorize -march=native -mavx      -funroll-loops -fomit-frame-pointer -fno-exceptions -fexpensive-optimizations aek.cpp -o bin/aek_x64_avx &
g++ -Ofast -Wall -flto -W -ftree-vectorize -march=native -mavx      -funroll-loops -fomit-frame-pointer -fno-exceptions -fexpensive-optimizations aek_2.cpp -o bin/aek2_x64_avx &
g++ -Ofast -Wall -flto -W -ftree-vectorize -march=native -mavx      -funroll-loops -fomit-frame-pointer -fno-exceptions -fexpensive-optimizations aek_3.cpp -o bin/aek3_x64_avx &
g++ -Ofast -Wall -flto -W -ftree-vectorize -m32 -march=native -mavx -funroll-loops -fomit-frame-pointer -fno-exceptions -fexpensive-optimizations aek.cpp -o bin/aek_x86_avx &
g++ -Ofast -Wall -flto -W -ftree-vectorize -m32 -march=native -mavx -funroll-loops -fomit-frame-pointer -fno-exceptions -fexpensive-optimizations aek_2.cpp -o bin/aek2_x86_avx &
g++ -Ofast -Wall -flto -W -ftree-vectorize -m32 -march=native -mavx -funroll-loops -fomit-frame-pointer -fno-exceptions -fexpensive-optimizations aek_3.cpp -o bin/aek3_x86_avx
