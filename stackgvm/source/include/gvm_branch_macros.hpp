...
#define beq_ii (i1, i2, j)  _CC(X_EQ_II),      _D8(i1), _D8(i2), _D16(j),
...
#define ceq_ii (i1, i2, j)  _CC(X_NE_II),      _D8(i1), _D8(i2), _D16(j),
...
#define bne_ii (i1, i2, j)  _CC(X_NE_II),      _D8(i1), _D8(i2), _D16(j),
...
#define cne_ii (i1, i2, j)  _CC(X_EQ_II),      _D8(i1), _D8(i2), _D16(j),
...
#define blt_ii (i1, i2, j)  _CC(I_LT_II),      _D8(i1), _D8(i2), _D16(j),

// Operand swapped
#define blt_il (I, i, l, j) _CC(I_GE_LI##I),   _D8(l),  _D8(i),  _D16(j),
...
#define clt_il (I, i, l, j) _CC(I_LT_LI##I),   _D8(l),  _D8(i),  _D16(j),
...
#define ble_ii (i1, i2, j)  _CC(I_LE_II),      _D8(i1), _D8(i2), _D16(j),

// Opperand swapped
#define ble_il (I, i, l, j) _CC(I_GT_LI##I),   _D8(l),  _D8(i),  _D16(j),
...
#define cle_ii (i1, i2, j)  _CC(I_GT_II),      _D8(i1), _D8(i2), _D16(j),

// Operand swapped and aliased
#define cle_il (I, i, l, j) _CC(I_LE_LI##I),   _D8(l),  _D8(i),  _D16(j),
...
#define bge_ii (i1, i2, j)  _CC(I_GE_II),      _D8(i1), _D8(i2), _D16(j),

#define bge_il (I, i, l, j) _CC(I_LT_LI##I),   _D8(l),  _D8(i),  _D16(j),
...
#define cge_ii (i1, i2, j)  _CC(I_LT_II),     _D8(i1), _D8(i2), _D16(j),

// Operand swapped and aliased
#define cge_il (I, i, l, j) _CC(I_GE_LI##I),   _D8(l),  _D8(i),  _D16(j),
...
#define bgt_ii (i1, i2, j)  _CC(I_GT_II),     _D8(i1), _D8(i2), _D16(j),

// Operand swapped
#define bgt_il (I, i, l, j) _CC(I_LE_LI##I),   _D8(l),  _D8(i),  _D16(j),
...
#define cgt_ii (i1, i2, j)  _CC(I_LE_II),     _D8(i1), _D8(i2), _D16(j),

// Operand swapped and aliased
#define cgt_il (I, i, l, j) _CC(I_GT_LI##I),   _D8(l),  _D8(i),  _D16(j),
...
#define fblt_ii (i1, i2, j)  _CC(F_LT_II),      _D8(i1), _D8(i2), _D16(j),

// Operand swapped
#define fblt_il (I, i, l, j) _CC(F_GE_LI##I),   _D8(l),  _D8(i),  _D16(j),
...
#define fclt_ii (i1, i2, j)  _CC(F_GE_II),      _D8(i1), _D8(i2), _D16(j),

// Operand swapped and aliased
#define fclt_il (I, i, l, j) _CC(F_LT_LI##I),   _D8(l),  _D8(i),  _D16(j),
...
#define fble_ii (i1, i2, j)  _CC(F_LE_II),      _D8(i1), _D8(i2), _D16(j),

// Operand swapped
#define fble_il (I, i, l, j) _CC(F_GT_LI##I),   _D8(l),  _D8(i),  _D16(j),
...
#define fcle_ii (i1, i2, j)  _CC(F_GT_II),      _D8(i1), _D8(i2), _D16(j),

// Operand swapped and aliased
#define fcle_il (I, i, l, j) _CC(F_LE_LI##I),   _D8(l),  _D8(i),  _D16(j),
...
#define fbge_ii (i1, i2, j)  _CC(F_GE_II),      _D8(i1), _D8(i2), _D16(j),

// Operand swapped
#define fbge_il (I, i, l, j) _CC(F_LT_LI##I),   _D8(l),  _D8(i),  _D16(j),
...
#define fcge_ii (i1, i2, j)  _CC(F_LT_II),      _D8(i1), _D8(i2), _D16(j),
...
#define fbgt_ii (i1, i2, j)  _CC(F_GT_II),      _D8(i1), _D8(i2), _D16(j),

#define fbgt_il (I, i, l, j) _CC(F_LE_LI##I),   _D8(l),  _D8(i),  _D16(j),
...
#define fcgt_ii (i1, i2, j)  _CC(F_LE_II),      _D8(i1), _D8(i2), _D16(j),
...
#define fbae_ii (i1, i2, j)  _CC(F_AE_II),      _D8(i1), _D8(i2), _D16(j),
...
#define vbeq_ii (i1, i2, j)  _CC(V_EQ_II),      _D8(i1), _D8(i2), _D16(j),
...
#define vceq_ii (i1, i2, j)  _CC(V_NE_II),      _D8(i1), _D8(i2), _D16(j),
...
#define vbae_ii (i1, i2, j)  _CC(V_AE_II),      _D8(i1), _D8(i2), _D16(j),
...
#define vbne_ii (i1, i2, j)  _CC(V_NE_II),      _D8(i1), _D8(i2), _D16(j),
