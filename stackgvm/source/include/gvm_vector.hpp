...
IS(VRND_L) {
    ...
    ScalarF x = (invRMax * std::rand()) - 1.0f;
    ScalarF y = (invRMax * std::rand()) - 1.0f;
    ScalarF z = (invRMax * std::rand()) - 1.0f;
...
IS(VMAG_IL) {
    ScalarF* v = OP_INDIRECT_0_VEC_3F(0);
    gvmDebugOpcode(
